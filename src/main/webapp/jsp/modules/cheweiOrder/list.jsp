        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">车位订单管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">车位订单列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">车位订单列表</h3>
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="cheweiNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="车位名称" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        车位地址
                                        <div class="layui-input-inline">
                                            <input type="text" id="cheweiAddressSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="车位地址" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
            ...
            if( cheweiNameSearchInput != null){
                if (cheweiNameSearchInput.val() != null && cheweiNameSearchInput.val() != '') {
                    searchForm.cheweiName = $('#cheweiNameSearch').val();
                            ...
                            //车位地址
            var cheweiAddressSearchInput = $('#cheweiAddressSearch');
            if( cheweiAddressSearchInput != null){
                if (cheweiAddressSearchInput.val() != null && cheweiAddressSearchInput.val() != '') {
                    searchForm.cheweiAddress = $('#cheweiAddressSearch').val();
                }
            }
        ...
        function getDataList() {
            ...
            //级联表的
                ...
                cheweiAddress: searchForm.cheweiAddress,
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(cheweiAddressCell);
                    ...
                    //车位月价格
            var cheweiNewMoneyCell = document.createElement('td');
            cheweiNewMoneyCell.innerHTML = item.cheweiNewMoney;
            row.appendChild(cheweiNewMoneyCell);


                    //车位详情
            var cheweiContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.cheweiContent && item.cheweiContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.cheweiContent.indexOf('<img');
                var endIndex = item.cheweiContent.indexOf('>');
                    cheweiContentCell.innerHTML = item.cheweiContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.cheweiContent != null && item.cheweiContent != "" && item.cheweiContent.length >= 11) {
                        cheweiContentCell.innerHTML = item.cheweiContent.substring(0, 10) + "...";
                } else {
                        cheweiContentCell.innerHTML = item.cheweiContent;
                }
            }
            row.appendChild(cheweiContentCell);
            ...
            //是否同意
            var cheweiOrderYesNoTypesCell = document.createElement('td');
            cheweiOrderYesNoTypesCell.innerHTML = item.cheweiOrderYesNoValue;
            row.appendChild(cheweiOrderYesNoTypesCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("cheweiOrder/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addcheweiOrder", "addcheweiOrder");
            window.location.href = "add-or-update.jsp"
        }
