            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">车位订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="cheweiNewMoney" name="cheweiNewMoney" class="form-control"
                                                   v-model="ruleForm.cheweiNewMoney" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>是否同意</label>
                                    <input id="cheweiOrderYesNoValue" name="cheweiOrderYesNoValue" class="form-control"
                                           v-model="ruleForm.cheweiOrderYesNoValue" readonly>
                                </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "cheweiOrder/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.cheweiContent != null && ruleForm.cheweiContent != 'null' && ruleForm.cheweiContent != '') {
            var cheweiContentUeditor = UE.getEditor('cheweiContentEditor');
                cheweiContentUeditor.ready(function () {
                    ...
                    cheweiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
