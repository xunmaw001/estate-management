    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(cheweiTypesCell);
                ...
                //车位图片
            var cheweiPhotoCell = document.createElement('td');
            var cheweiPhotoImg = document.createElement('img');
            var cheweiPhotoImgValue = item.cheweiPhoto;
            if(cheweiPhotoImgValue !=null && cheweiPhotoImgValue !='' && cheweiPhotoImgValue !='null'){
                cheweiPhotoImg.setAttribute('src', cheweiPhotoImgValue);
                cheweiPhotoImg.setAttribute('height', 100);
                cheweiPhotoImg.setAttribute('width', 100);
                cheweiPhotoCell.appendChild(cheweiPhotoImg);
            }else{
                cheweiPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(cheweiPhotoCell);
