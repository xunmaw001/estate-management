...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="jiaofeiNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="缴费名称" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        月份
                                        <div class="layui-input-inline">
                                            <input type="text" id="jiaofeiTimeSearch" style="width: 140px;" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //月份
            var jiaofeiTimeSearchInput = $('#jiaofeiTimeSearch');
            if( jiaofeiTimeSearchInput != null){
                if (jiaofeiTimeSearchInput.val() != null && jiaofeiTimeSearchInput.val() != '') {
                    searchForm.jiaofeiTime = $('#jiaofeiTimeSearch').val();
                }
            }
        ...
        function getDataList() {
            http("jiaofei/page", "GET", {
                ...
                jiaofeiTime: searchForm.jiaofeiTime,
        ...
        function setDataRow(item, number) {
            ...
            //月份
            var jiaofeiTimeCell = document.createElement('td');
            jiaofeiTimeCell.innerHTML = item.jiaofeiTime;
            row.appendChild(jiaofeiTimeCell);
            ...
            //缴费金额
            var jiaofeiYuMoneyCell = document.createElement('td');
            jiaofeiYuMoneyCell.innerHTML = item.jiaofeiYuMoney;
            row.appendChild(jiaofeiYuMoneyCell);


            //实收金额
            var jiaofeiShiMoneyCell = document.createElement('td');
            jiaofeiShiMoneyCell.innerHTML = item.jiaofeiShiMoney;
            row.appendChild(jiaofeiShiMoneyCell);
