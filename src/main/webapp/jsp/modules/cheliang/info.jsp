                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>车辆类型</label>
                                    <input id="cheliangValue" name="cheliangValue" class="form-control"
                                           v-model="ruleForm.cheliangValue" readonly>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="chepai" name="chepai" class="form-control"
                                               v-model="ruleForm.chepai" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.cheliangContent != null && ruleForm.cheliangContent != 'null' && ruleForm.cheliangContent != '') {
            var cheliangContentUeditor = UE.getEditor('cheliangContentEditor');
                cheliangContentUeditor.ready(function () {
                    var mes = '' + ruleForm.cheliangContent;
                    cheliangContentUeditor.setContent(mes);
                    cheliangContentUeditor.setDisabled('fullscreen');
            });
        }
    }
