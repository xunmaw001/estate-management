...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="cheliangNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="车辆名称" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        车牌
                                        <div class="layui-input-inline">
                                            <input type="text" id="chepaiSearch" style="width: 140px;" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //车牌
            var chepaiSearchInput = $('#chepaiSearch');
            if( chepaiSearchInput != null){
                if (chepaiSearchInput.val() != null && chepaiSearchInput.val() != '') {
