              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">车辆名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="cheliangName" id="cheliangName"  placeholder="车辆名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">车辆类型:</span>
                        <div class="layui-input-inline">
                            <select name="cheliangTypes" id="cheliangTypes" lay-filter="cheliangTypes" style="width: 600px;">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">车牌:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="chepai" id="chepai"  placeholder="车牌"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'form', 'http', 'jquery', 'laydate'], function() {
      ...
      function cheliangTypesSelect() {
        //填充下拉框选项
          http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=cheliang_types", "GET", {}, (res) => {
              if(res.code == 0){
