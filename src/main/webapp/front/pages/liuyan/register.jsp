              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">留言名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="liuyanName" id="liuyanName"  placeholder="留言名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">留言类型:</span>
                        <div class="layui-input-inline">
                            <select name="liuyanTypes" id="liuyanTypes" lay-filter="liuyanTypes" style="width: 600px;">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'form', 'http', 'jquery', 'laydate'], function() {
      ...
      function liuyanTypesSelect() {
        //填充下拉框选项
          http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=liuyan_types", "GET", {}, (res) => {
              if(res.code == 0){
