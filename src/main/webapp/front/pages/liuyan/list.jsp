            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">留言展示</span>
                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">留言名称</label>
                          <div class="layui-input-inline">
                              <input type="text" name="liuyanName" id="liuyanName" placeholder="留言名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="liuyanTypes" id="liuyanTypes" lay-filter="liuyanTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in liuyanTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 liuyanContent 字段去除无用字符 如果字段长度大于60  就截取到60
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            var liuyanTypes = $("#liuyanTypes").find("option:selected").val();
            if (liuyanTypes != null && liuyanTypes != "" && liuyanTypes != "null") {
                param['liuyanTypes'] = liuyanTypes;
            }
                                            // 获取列表数据
    ...
    // 当前表的字典表
       ...
       function liuyanTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=liuyan_types", 'get', {}, function (res) {
               if(res.code == 0){
                   vue.liuyanTypesList = res.data.list;
               }
           });
       }
