                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="building" id="building" placeholder="楼栋" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="unit" id="unit" placeholder="单元" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="room" id="room" placeholder="房间号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#building').val() != null && jquery('#building').val() != "" && jquery('#building').val() != "null" ) {
                param['building'] = jquery('#building').val();
            }
         
            if (jquery('#unit').val() != null && jquery('#unit').val() != "" && jquery('#unit').val() != "null" ) {
                param['unit'] = jquery('#unit').val();
            }
         
            if (jquery('#room').val() != null && jquery('#room').val() != "" && jquery('#room').val() != "null" ) {
                param['room'] = jquery('#room').val();
            }
                                    // 获取列表数据
