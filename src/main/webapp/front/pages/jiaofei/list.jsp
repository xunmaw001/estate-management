            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">缴费展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jiaofeiName" id="jiaofeiName" placeholder="缴费名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jiaofeiTime" id="jiaofeiTime" placeholder="月份" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="jiaofeiTypes" id="jiaofeiTypes" lay-filter="jiaofeiTypes">
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 jiaofeiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            jiaofeiContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#jiaofeiName').val() != null && jquery('#jiaofeiName').val() != "" && jquery('#jiaofeiName').val() != "null" ) {
                param['jiaofeiName'] = jquery('#jiaofeiName').val();
            }
         
            if (jquery('#jiaofeiTime').val() != null && jquery('#jiaofeiTime').val() != "" && jquery('#jiaofeiTime').val() != "null" ) {
                param['jiaofeiTime'] = jquery('#jiaofeiTime').val();
            }
         
            var jiaofeiTypes = $("#jiaofeiTypes").find("option:selected").val();
            if (jiaofeiTypes != null && jiaofeiTypes != "" && jiaofeiTypes != "null") {
                param['jiaofeiTypes'] = jiaofeiTypes;
            }
                                            // 获取列表数据
            http.request('jiaofei/list', 'get', param, function(res) {
    ...
    // 当前表的字典表
       ...
       function jiaofeiTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiaofei_types", 'get', {}, function (res) {
               if(res.code == 0){
