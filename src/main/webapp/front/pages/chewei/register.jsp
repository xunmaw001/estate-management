              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">车位名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="cheweiName" id="cheweiName"  placeholder="车位名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">车位地址:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="cheweiAddress" id="cheweiAddress"  placeholder="车位地址"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">是否被使用:</span>
                        <div class="layui-input-inline">
                            <select name="cheweiTypes" id="cheweiTypes" lay-filter="cheweiTypes" style="width: 600px;">
