            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">服务展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="fuwuName" id="fuwuName" placeholder="服务名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="fuwuTypes" id="fuwuTypes" lay-filter="fuwuTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in fuwuTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="fuwuYesNoTypes" id="fuwuYesNoTypes" lay-filter="fuwuYesNoTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in fuwuYesNoTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 fuwuContent 字段去除无用字符 如果字段长度大于60  就截取到60
            fuwuContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#fuwuName').val() != null && jquery('#fuwuName').val() != "" && jquery('#fuwuName').val() != "null" ) {
                param['fuwuName'] = jquery('#fuwuName').val();
            }
         
            var fuwuTypes = $("#fuwuTypes").find("option:selected").val();
            if (fuwuTypes != null && fuwuTypes != "" && fuwuTypes != "null") {
                param['fuwuTypes'] = fuwuTypes;
            }
                         
            var fuwuYesNoTypes = $("#fuwuYesNoTypes").find("option:selected").val();
            if (fuwuYesNoTypes != null && fuwuYesNoTypes != "" && fuwuYesNoTypes != "null") {
                param['fuwuYesNoTypes'] = fuwuYesNoTypes;
            }
                    // 获取列表数据
            http.request('fuwu/list', 'get', param, function(res) {
    ...
    // 当前表的字典表
       ...
       function fuwuTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=fuwu_types", 'get', {}, function (res) {
               if(res.code == 0){
                   vue.fuwuTypesList = res.data.list;
               }
           });
       }
       ...
       function fuwuYesNoTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=fuwu_yes_no_types", 'get', {}, function (res) {
               if(res.code == 0){
                   vue.fuwuYesNoTypesList = res.data.list;
               }
           });
       }
