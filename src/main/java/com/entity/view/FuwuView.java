...
public class FuwuView extends FuwuEntity implements Serializable {
	...
	public FuwuView(FuwuEntity fuwuEntity) {
		try {
			...
			* 获取： 是否同意的值
			*/
			public String getFuwuYesNoValue() {
				return fuwuYesNoValue;
			}
			/**
			* 设置： 是否同意的值
			*/
			public void setFuwuYesNoValue(String fuwuYesNoValue) {
				this.fuwuYesNoValue = fuwuYesNoValue;
			}
