...
public class TousuView extends TousuEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 是否处理的值
		*/
		private String tousuYesNoValue;
	...
	public TousuView(TousuEntity tousuEntity) {
		try {
			...
			* 获取： 是否处理的值
			*/
			public String getTousuYesNoValue() {
				return tousuYesNoValue;
			}
			/**
			* 设置： 是否处理的值
			*/
			public void setTousuYesNoValue(String tousuYesNoValue) {
				this.tousuYesNoValue = tousuYesNoValue;
			}
