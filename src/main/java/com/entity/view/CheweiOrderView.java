...
public class CheweiOrderView extends CheweiOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 是否同意的值
		*/
		private String cheweiOrderYesNoValue;
	...
	public CheweiOrderView(CheweiOrderEntity cheweiOrderEntity) {
		try {
			...
			* 获取： 是否同意的值
			*/
			public String getCheweiOrderYesNoValue() {
				return cheweiOrderYesNoValue;
			}
			/**
			* 设置： 是否同意的值
			*/
			public void setCheweiOrderYesNoValue(String cheweiOrderYesNoValue) {
				this.cheweiOrderYesNoValue = cheweiOrderYesNoValue;
			}
